export const buildings = [
  ...
  },
  {
    ...
    "Старі назви вулиці":
      "Lelowa / Лельова (XVI ст. - кін. XIX ст.); Adama Mickiewicza / Адама Міцкевича (кін. XIX ст. - )",
    Дата: "до 1944 р. (?)",
    Опис: "Партеровий будинок з дерев'яною ґалєрією. Дах покритий червоною дахівкою",
    "Архітектурний стиль": "",
    Історія: "",
  ...
  },
  {
    ...
    "Старі назви вулиці":
      "Lelowa / Лельова (XVI ст. - кін. XIX ст.); Adama Mickiewicza / Адама Міцкевича (кін. XIX ст. - )",
    Дата: "до 1944 р.",
    Опис: "Партеровий будинок з дерев'яною ґалєрією",
    "Архітектурний стиль": "",
    Історія: "",
  ...
  },
  {
    ...
    "Архітектурний стиль": "",
    Історія:
      'сер. XIX ст. - 1900-ті рр. - Готель "Ґаліція" - покої для сніданків, ресторація, більярд та ін. азартні ігри; 1880 р. - зупиняється Іван Франко; 1900-ті рр. - готель і ресторація "Беллє-Вує" (власник Х. Бар); 1920-ті рр. - гурток есперантистів Ореста Кузьми (II поверх)',
  ...
  },
  {
    ...
    "Архітектурний стиль": "",
    Історія:
      "кін. XIX - поч. XX ст. - склеп (крамниця) промислових і господарських товарів [29]; 1923 р. - Wodne szkło do konserwowania jej na zimie. Wody mineralne w pastylkach kąpiele z kwasem węglowym poleca DROGUERJA A. HIRNLEGO Rynek, 46 A-A. / Крамниця побутової хімії А. Гірнля [175]",
  ...
  },
  {
    ...
    "Архітектурний стиль": "",
    Історія:
      "1923 р. - Poleca się Restaurację K. Ehrlicha w Kołomyi, ul. Ciasna. LOKAL ZUPEŁNIE ODNOWIONY. Ciepłe i zimne przekąski. - Smaczne potrawy sporządzone na świeżem maśle deserowem. Ceny umiarkowane. O liczne odwiedzine uprasza WESOŁOWSKI. / Ресторація К. Ерліха (?) [174]",
  ...
  },
  {
    ...
    "Архітектурний стиль": "",
    Історія:
      "1923 р. - Kto chce korzystać ze świeżego powietrza, niech się uda wieczorem około godziny 6-ej do parku miejskiego, a z pewnością tego nie odżałuje, gdyż w tym czasie jest tam powietrze najwonniejsze - dzięki bliskości kloaków w sąsiednich domach. Pożądanem byłoby by świetny Magistrat lub Komisja sanitarna zechciały wydać stosowne zarządzenie i park miejski uwolnić od tych zapachów. / Скарга на сморід в парку від кльозетів сусідніх будинків [175]",
    Адреса: "",
    Широта: 48.5289,
    Довгота: 25.0483,
  },
